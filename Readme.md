...
Incluye un **backend FastAPI**, un **frontend Next.js** y **4 micro-servicios MCP** (vuelos, hoteles, destinos y cálculo).
...
## ⚙️ 2) Configura tus claves (opcional pero recomendado)
...
El `docker-compose.yml` inyecta estas variables automáticamente si existen,  
pero **no son obligatorias** para arrancar.

---

## 🚢 3) Arranque súper rápido
...
| Calc | [http://127.0.0.1:8770/docs](http://127.0.0.1:8770/docs) |
| Flights | [http://127.0.0.1:8771/docs](http://127.0.0.1:8771/docs) |
| Hotels | [http://127.0.0.1:8772/docs](http://127.0.0.1:8772/docs) |
| Destinations | [http://127.0.0.1:8773/docs](http://127.0.0.1:8773/docs) |
...
$body = @{
  user     = "Demo"
  message  = "Quiero un viaje de 2 días a Palma de Mallorca"
  convo_id = ""
} | ConvertTo-Json
...
**Últimas líneas de todos los servicios:**
...
## 🧰 7) Problemas típicos y solución rápida

**❌ El backend intenta llamar a `127.0.0.1` desde Docker**
...
**⚠️ Aviso: `WEATHER_API_KEY` no definida**

Es opcional. Si quieres quitar el warning, añade la clave en tu `.env`.
...
Si quieres que este README se vea perfecto en GitHub, guárdalo como `README.md` en la raíz del repositorio.  
GitHub renderiza automáticamente enlaces, tablas y bloques de código como en este ejemplo.
